...
function Experience() {
  ...
  return (
    <section
      className="retro-tech-section desktop-scroll-margin"
      id="experience"
    >
      <div className="screen-container">
        <div className="content-container">
          ...
          <div className="teams-section">
            <div className="section-header">
              ...
              <h2 className="section-title">NFC_3.0_ACTIVITIES</h2>
            </div>
            <div
            ...
            >
              ...
              <button
                ...
                onClick={nextSlide}
                disabled={
                  currentCarouselIndex >= otherTeams.length - cardsPerView
                }
        ...
        <div className="carousel-progress">
          {Array.from({
            length: Math.max(1, otherTeams.length - cardsPerView + 1),
          }).map((_, index) => (
            <div
              key={index}
